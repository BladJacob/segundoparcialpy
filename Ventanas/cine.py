...
#Titulo
titulo = tk.Label(ventana, text="Compra de Boletos", font=("Arial", 20, "bold"), bg="#13216a", fg="white").pack(pady=60, padx=150)

#Frame de entradas
frame_entradas = tk.LabelFrame(ventana, text="Datos del comprador",  bg="#13216a", fg="white" )
frame_entradas.place(x=1100, y=100, width=400, height=200)
...
#Frame de resultado
frame_resultado = tk.LabelFrame(ventana, text="Valor a pagar",  bg="#13216a", fg="white", padx=10, pady=10)
frame_resultado.place(x=300, y=100, width=200, height=200)
etiqueta_valor_pagar = tk.Label(frame_resultado, text="$0.00", font=("Arial", 14, "bold"))
etiqueta_valor_pagar.grid(row=0, column=3)

#Frame de acciones
frame_acciones = tk.LabelFrame(ventana, text="Acciones",  bg="#13216a", fg="white", padx=10, pady=10)
frame_acciones.place(x=100, y=100, width=200, height=200)
